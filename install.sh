...
# Create launcher
echo "==> Creating 'elden-save' executable launcher..."
cat << LAUNCHER > "$BIN_DIR/elden-save"
#!/usr/bin/env bash
exec "$VENV_DIR/bin/elden-save" "\$@"
LAUNCHER
chmod +x "$BIN_DIR/elden-save"
